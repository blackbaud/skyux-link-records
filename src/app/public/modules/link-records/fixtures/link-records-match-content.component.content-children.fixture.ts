...
@Component({
  selector: 'sky-link-records-match-content-fixture-content-children',
  templateUrl: './link-records-match-content.component.content-children.fixture.html'
})
export class SkyLinkRecordsMatchContentContentChildrenTestComponent {
